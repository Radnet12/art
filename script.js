...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.calc-form .promocode', '.calc-form .calc-price');
...
var modals = function modals() {
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true, true); // showModalByTime('.popup-consultation', 60000);
